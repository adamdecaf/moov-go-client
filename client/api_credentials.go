...
func (a *CredentialsApiService) DisableCredentials(ctx _context.Context, identityID string, credentialID string) (*_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/v1/identities/{identityID}/credentials/{credentialID}"
...
func (a *CredentialsApiService) ListCredentials(ctx _context.Context, identityID string) ([]Credential, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/identities/{identityID}/credentials"
	localVarPath = strings.Replace(localVarPath, "{"+"identityID"+"}", _neturl.QueryEscape(parameterToString(identityID, "")), -1)

...
type FileHeader struct {
	...
	// expressed in a \"YYMMDD\" format. The File Creation Date is the date on which the file is prepared by an ODFI
	FileCreationDate string `json:"fileCreationDate,omitempty"`
	// Expressed in \"HHMM\" (24 hour clock) format.
